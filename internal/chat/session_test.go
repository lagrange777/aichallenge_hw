...
func (f *fakeResponder) Respond(_ context.Context, _ string, previousID string, options ResponseOptions) (string, string, error) {
...
func TestSessionPassesTrimmedResponseOptions(t *testing.T) {
	...
	want := ResponseOptions{Format: "JSON", LengthLimit: "200 words", CompletionCondition: "after summary"}
